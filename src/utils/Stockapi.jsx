...
export const searchSymbol = async (query) => {
  const url = `${basePath}/search?q=${query}&token=cfsbm31r01qgkckhcg6gcfsbm31r01qgkckhcg70`;
...
export const fetchStockDetails = async (stockSymbol) => {
  const url = `${basePath}/stock/profile2?symbol=${stockSymbol}&token=cfsbm31r01qgkckhcg6gcfsbm31r01qgkckhcg70`;
  const response = await fetch(url);
...
export const fetchQuote = async (stockSymbol) => {
  const url = `${basePath}/quote?symbol=${stockSymbol}&token=cfsbm31r01qgkckhcg6gcfsbm31r01qgkckhcg70`;
  const response = await fetch(url);
...
export const fetchHistoricalData = async (
  ...
  const url = `${basePath}/stock/candle?symbol=${stockSymbol}&resolution=${resolution}&from=${from}&to=${to}&token=cfsbm31r01qgkckhcg6gcfsbm31r01qgkckhcg70`;
  const response = await fetch(url);
